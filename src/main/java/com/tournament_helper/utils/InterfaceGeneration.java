package com.tournament_helper.utils;
...
public class InterfaceGeneration {
    ...
    public static void startInterface(PlayerService playerService, MatchService matchService) {
        ...
        // Tornar todas as células nao editáveis.
        ...
        enterButton.addActionListener(e -> {
            ...
            java.util.List<Match> matches = matchService.findAllMatches(playerId);
